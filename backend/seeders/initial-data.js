    ...
    await queryInterface.bulkInsert('posts', [
      {
        ...
        status: 'published',
        category: 'Giới thiệu',
        tags: JSON.stringify(['platform', 'introduction', 'media']),
        likes: 150,
        comments_count: 23,
        views: 1250,
        time: new Date('2024-11-01 09:00:00'),
      ...
      },
      {
        ...
        status: 'published',
        category: 'Marketing',
        tags: JSON.stringify(['social media', 'tips', 'content creation']),
        likes: 89,
        comments_count: 15,
        views: 567,
        time: new Date('2024-11-15 14:30:00'),
      ...
      },
      {
        ...
        type: 'video',
        video_url: 'https://example.com/video/livestream-guide.mp4',
        account_id: 3,
        status: 'published',
        category: 'Video',
        tags: JSON.stringify(['livestream', 'video', 'tutorial']),
        likes: 234,
        comments_count: 45,
        views: 2100,
        time: new Date('2024-11-20 16:00:00'),
      ...
      },
      {
        ...
        status: 'published',
        category: 'Marketing',
        tags: JSON.stringify(['content marketing', 'strategy', '2024']),
        likes: 178,
        comments_count: 32,
        views: 980,
        time: new Date('2024-11-25 10:00:00'),
      ...
      },
      {
        ...
        tags: JSON.stringify(['vietnam', 'nature', 'photography']),
        likes: 456,
        comments_count: 67,
        views: 3200,
      ...
      },
      {
        ...
        type: 'video',
        video_url: 'https://example.com/video/product-review.mp4',
        account_id: 5,
        status: 'published',
        category: 'Review',
        tags: JSON.stringify(['review', 'technology', 'product']),
        likes: 312,
        comments_count: 89,
        views: 2567,
        time: new Date('2024-12-01 15:00:00'),
      ...
      },
      {
        ...
        status: 'pending',
        category: 'Tutorial',
        tags: JSON.stringify(['video editing', 'premiere pro', 'tutorial']),
        likes: 45,
        comments_count: 8,
        views: 234,
        time: new Date('2024-12-05 11:00:00'),
        published_at: null
      }
    ], {});
