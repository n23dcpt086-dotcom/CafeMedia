...
module.exports = {
  async up(queryInterface, Sequelize) {
    // ID mapping do đổi thứ tự accounts (old -> new):
    // 1->1, 2->4, 3->5, 4->6, 5->7, 6->2, 7->3

    // ACCOUNTS (đưa 3 admin lên đầu để auto-increment id = 1,2,3)
    await queryInterface.bulkInsert(
      ...
      [
        // new id 1 (old id 1)
        {
          ...
          password:
            '$2a$12$pakdV6AaYgNDyB9SADVrZeNo7laY/Y2XBTkGxDZac4O0TfaHjsHGe', // password: n23dcpt086
          role: 'admin',
          phone: '0901234567',
        ...
        // new id 2 (old id 6)
        {
          ...
          password:
            '$2a$12$T60tve7iXqaAHydDq/p3M.CuUiF1eGczhwisi0pdNnbCYEAioJRhe', // password: n23dcpt059
          role: 'admin',
          phone: '0901234565',
        ...
        // new id 3 (old id 7)
        {
          ...
          password:
            '$2a$12$/r9cuMvQ2.8gAUs6kpnIzO1ln1y5TfU7gh26yjX3vlAO3atJfyAwa', // password: n23dcpt067
          role: 'admin',
          phone: '0901234564',
          date_of_birth: '2005-01-01',
          avatar: 'https://i.pravatar.cc/150?img=1',
        ...
        // new id 4 (old id 2)
        {
          ...
          password:
            '$2a$12$2IqmMivBOqC58.5t8324OeqaSdzeTO5Ey4vyMG8dWS0qtKSF7BtOC', // password: user001
          role: 'user',
          phone: '0912345678',
        ...
        // new id 5 (old id 3)
        {
          ...
          password:
            '$2a$12$HXXmHuXIgZ1ecVe2tlDVC.8MZedpJTj.HoMl2WDCMlOGDFGEnNJJO', // password: user002
          role: 'user',
          phone: '0923456789',
        ...
        // new id 6 (old id 4)
        {
          ...
          password:
            '$2a$12$01DTJ3vRC9yhAD65a0PkZ.3h.VtTnlhHrtEA6SahY5t93yYqeENOq', // password: user003
          role: 'user',
          phone: '0934567890',
        ...
        // new id 7 (old id 5)
        {
          ...
          password:
            '$2a$12$oEPc1GZARCySggV2L7SEv.XBQxUVjnv1XZwqF33ZvLg0u.4WCTERW', // password: user004
          role: 'user',
          phone: '0945678901',
    ...
    // POSTS (đổi tiêu đề/nội dung để khớp lịch trình; giữ nguyên số lượng + trường)
    await queryInterface.bulkInsert(
      'posts',
      [
        {
          title: 'Lịch đăng bài: Chiến dịch Tết (Checklist & nội dung đề xuất)',
          body: 'Tổng hợp checklist nội dung cho Chiến dịch Tết: thông điệp, hashtag, key visual, khung giờ đăng và CTA theo từng kênh.',
          account_id: 1,
          status: 'published',
          tag: 'Lịch trình',
        ...
        {
          title: 'Kế hoạch bài viết: 10 tips tăng tương tác Social Media (theo lịch)',
          body: 'Bài viết dùng để lên lịch đăng: 10 tips tăng tương tác, gợi ý caption, định dạng (carousel/reel) và KPI theo từng kênh.',
          account_id: 1,
          status: 'draft',
          tag: 'Lịch trình',
        ...
        {
          title: 'Kịch bản video: Hướng dẫn livestream chuyên nghiệp (theo lịch đăng)',
          body: 'Kịch bản livestream: mở đầu, giới thiệu, demo, Q&A, chốt đơn; danh sách thiết bị và cấu hình cơ bản cho từng mức ngân sách.',
        ...
        {
          title: 'Bài đăng theo lịch: Chiến lược Content Marketing (chuẩn bị publish)',
          body: 'Khung chiến lược content marketing: chủ đề theo tuần, lịch publish, quy tắc SEO on-page, theo dõi hiệu quả và tối ưu sau đăng.',
          account_id: 1,
          status: 'published',
          tag: 'Lịch trình',
        ...
        {
          title: 'Bản nháp: Tổng kết năm 2024 (outline + số liệu cần chuẩn bị)',
          body: 'Outline cho bài tổng kết: top nội dung, tăng trưởng kênh, bài học, kế hoạch 2025; danh sách số liệu cần trích xuất để làm infographic.',
          account_id: 1,
          status: 'draft',
          tag: 'Lịch trình',
          published_at: new Date('2024-12-20 08:00:00'),
        },
        {
          title: 'Bài đăng theo lịch: Ảnh thiên nhiên Việt Nam (caption + khung giờ)',
          body: 'Bộ caption gợi ý cho bài ảnh, hashtag, khung giờ đăng tối ưu theo kênh và cách gắn tag/địa điểm để tăng reach.',
        ...
        {
          title: 'Bài đăng theo lịch: Review sản phẩm mới (dàn ý + tiêu chí)',
          body: 'Dàn ý review: điểm nổi bật, so sánh, ưu/nhược, đối tượng phù hợp; gợi ý ảnh/clip minh họa và CTA để chuyển đổi.',
          video_url: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
          account_id: 1,
          status: 'draft',
          tag: 'Review',
        ...
        {
          title: 'Kịch bản tutorial: Chỉnh sửa video với Premiere Pro (part 1)',
          body: 'Nội dung cho video tutorial part 1: dựng timeline, cắt ghép cơ bản, audio, export; checklist trước khi upload theo lịch.',
          account_id: 1,
          status: 'draft',
          tag: 'Tutorial',
          published_at: new Date('2024-12-01 12:00:00'),
        },
      ],
      {}
    );

    // COMMENTS (đổi account_id theo mapping; giữ nguyên text + trường)
    await queryInterface.bulkInsert(
      'comments',
      [
        { post_id: 1, account_id: 4, text: 'Bài viết rất hay và hữu ích! Cảm ơn admin đã chia sẻ.', created_at: new Date('2024-11-01 10:00:00') },
        { post_id: 1, account_id: 5, text: 'Mình đã áp dụng và thấy rất hiệu quả. Thanks!', created_at: new Date('2024-11-01 11:30:00') },
        { post_id: 1, account_id: 6, text: 'Có thể hướng dẫn chi tiết hơn được không ạ?', created_at: new Date('2024-11-01 14:00:00') },

        { post_id: 2, account_id: 1, text: 'Bài viết chất lượng! Keep up the good work!', created_at: new Date('2024-11-15 15:00:00') },
        { post_id: 2, account_id: 7, text: 'Mình đã thử theo các tips này và thấy engagement tăng lên rõ rệt.', created_at: new Date('2024-11-15 16:30:00') },

        { post_id: 3, account_id: 4, text: 'Video rất chi tiết và dễ hiểu. Cảm ơn bạn!', created_at: new Date('2024-11-20 17:00:00') },
        { post_id: 3, account_id: 6, text: 'Mình có thể dùng những thiết bị nào để livestream?', created_at: new Date('2024-11-20 18:00:00') },
        { post_id: 3, account_id: 1, text: 'Bạn có thể dùng smartphone, webcam hoặc camera chuyên nghiệp đều được.', created_at: new Date('2024-11-20 18:30:00') },

        { post_id: 4, account_id: 5, text: 'Xu hướng 2024 thật sự rất thú vị. Mình sẽ thử áp dụng.', created_at: new Date('2024-11-25 11:00:00') },
        { post_id: 4, account_id: 7, text: 'Bài viết rất insightful. Có thêm case study được không ạ?', created_at: new Date('2024-11-25 13:00:00') },

        { post_id: 6, account_id: 1, text: 'Những bức ảnh tuyệt đẹp! Việt Nam mình đẹp quá!', created_at: new Date('2024-11-28 09:00:00') },
        { post_id: 6, account_id: 4, text: 'Chụp ở đâu vậy bạn? Mình muốn đi thăm.', created_at: new Date('2024-11-28 10:30:00') },
        { post_id: 6, account_id: 5, text: 'Góc chụp và màu sắc rất ấn tượng!', created_at: new Date('2024-11-28 14:00:00') },

        { post_id: 7, account_id: 4, text: 'Review chi tiết và khách quan. Thanks!', created_at: new Date('2024-12-01 16:00:00') },
        { post_id: 7, account_id: 6, text: 'Mình đang cân nhắc mua sản phẩm này. Review giúp mình quyết định rồi.', created_at: new Date('2024-12-01 17:30:00') },
      ],
      {}
    );

    // CAMPAIGNS (đổi account_id theo mapping; giữ nguyên trường)
    await queryInterface.bulkInsert(
      'campaigns',
      [
        {
    ...
    // SCHEDULES (account_id giữ nguyên 1; post_id giữ nguyên; không thêm/bớt trường)
    await queryInterface.bulkInsert(
      'schedules',
      [
        {
          title: 'Đăng bài về Chiến dịch Tết',
          publish_time: '2025-12-20 08:00:00',
          channel: 'fb',
        ...
        },
        {
          ...
          publish_time: '2025-12-22 09:00:00',
          channel: 'yt',
        ...
        },
        {
          ...
          publish_time: '2025-12-25 10:00:00',
          channel: 'tt',
        ...
        },
        {
          ...
          publish_time: '2025-12-28 11:00:00',
          channel: 'web',
        ...
        },
        {
          ...
          publish_time: '2025-12-30 12:00:00',
          channel: 'fb',
        ...
        },
        {
          ...
          publish_time: '2025-12-05 13:00:00',
          channel: 'web',
        ...
        },
        {
          ...
          publish_time: '2025-12-08 14:00:00',
          channel: 'yt',
        ...
        },
        {
          ...
          publish_time: '2025-12-10 15:00:00',
          channel: 'fb',
        ...
        },
        {
          ...
          publish_time: '2025-12-15 16:00:00',
          channel: 'web',
        ...
        },
        {
          ...
          publish_time: '2025-12-18 17:00:00',
          channel: 'tt',
        ...
        },
        {
          ...
          publish_time: '2025-12-20 18:00:00',
          channel: 'fb',
        ...
        },
        {
          ...
          publish_time: '2025-12-25 19:00:00',
          channel: 'yt',
    ...
    // LIVESTREAMS (đổi account_id theo mapping; giữ nguyên trường)
    await queryInterface.bulkInsert(
      'livestreams',
      [
        {
